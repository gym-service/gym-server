# -*- coding: utf-8 -*-
# Generated by Django 1.9c1 on 2015-12-16 16:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Immaginigallerie',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('immmagine', models.ImageField(upload_to='immagini', verbose_name='Immagine')),
                ('galleria', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='gym_contents.Gallery')),
            ],
            options={
